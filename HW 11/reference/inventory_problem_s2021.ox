...
decl pr=4;
decl c=1;
decl gamma=1/2;	 // what is this used for?

decl mF1,mF0,mS;

/* Simulated choices and states */
decl vPhat;     /* Estimated choice-probalities Sx1 */
...
main()
{
  ...
  // CCP iteration 
  decl vP=constant(1/2,S,1),vP0,vEV; // initialize values
  decl it=0;						 // iteration counter
  decl eps=10^(-10);				 // tolerance value
  do{								 // CCP iteration
    vP0=vP;
    ccp(&vEV,&vP,vP0);
    it+=1;
